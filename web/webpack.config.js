...
module.exports = {
  ...
  entry: {
    ...
    digiPantryCreateMealPlan: path.resolve(__dirname, 'src', 'pages', 'digiPantryCreateMealPlan.js'),
    digiPantryMealPlanDetails: path.resolve(__dirname, 'src', 'pages', 'digiPantryMealPlanDetails.js'),
